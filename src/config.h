...
#define G_GRAV_CONST2         (G_GRAV_CONST* G_GRAV_CONST) // G*G as requested
...
extern const char *inputsig; // Or const char *inputsig; - typically const char* for string literals
