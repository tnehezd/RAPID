 ...
 */
void eqrhs(long double pradius, long double dp, long double sigma, long double ug, long double r, long double *drdt, const disk_t *disk_params);
 ...
 */
long double Coeff_1(long double r, const disk_t *disk_params);
 ...
 */
long double Coeff_2(long double r, const disk_t *disk_params);
 ...
 */
long double time_step(const disk_t *disk_params);
 ...
 */
void int_step(long double time, long double prad, const long double *sigmad, const long double *rdvec, long double step, long double y, long double *ynew, long double *pradnew, const disk_t *disk_params, const simulation_options_t *sim_opts);
