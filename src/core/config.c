...
const char * const kDustDensityProfileFilePrefix = "dust_density_profile";
const char * const kMicronDustDensityProfileFilePrefix = "dust_micron_density_profile";
...
const char * const kDustParticleSizeFileName = "dust_size_evolution";
const char * const kMicronDustParticleSizeFileName = "micron_dust_size_evolution";
